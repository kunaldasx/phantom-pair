    ...
    openaiModels: [
      {
        id: 'gpt-5',
        name: 'GPT-5',
        description: 'Most advanced for complex reasoning and accurate problem extraction'
      },
      {
        id: 'gpt-4o',
        name: 'GPT-4o',
        description: 'State-of-the-art multimodal model, excellent for vision and extraction'
      },
      {
        id: 'o4-mini',
        name: 'o4-mini',
        description: 'Efficient and cost-effective option for extraction with deep reasoning'
      }
    ],
    geminiModels: [
      {
        id: 'gemini-2.5-pro',
        name: 'Gemini 2.5 Pro',
        description: 'Most advanced reasoning for complex problem extraction'
      },
      {
        id: 'gemini-2.5-flash',
        name: 'Gemini 2.5 Flash',
        description: 'Best balance for screenshot analysis and problem extraction'
      },
      {
        id: 'gemini-2.5-flash-lite',
        name: 'Gemini 2.5 Flash-Lite',
        description: 'Fast and cost-effective for problem extraction with high quota'
      }
    ]
  },

  {
    ...
    openaiModels: [
      ...
      },
      {
        id: 'gpt-4o',
        name: 'GPT-4o',
        description: 'State-of-the-art multimodal model for code generation'
      },
      {
        id: 'o4-mini',
        name: 'o4-mini',
        description: 'Strong reasoning and efficient solution generation'
      }
    ],
    geminiModels: [
      {
        id: 'gemini-2.5-pro',
        name: 'Gemini 2.5 Pro',
        description: 'Most advanced reasoning for complex coding solutions'
      },
      {
        id: 'gemini-2.5-flash',
        name: 'Gemini 2.5 Flash',
        description: 'Fast and reliable solution generation with good quality'
      },
      {
        id: 'gemini-2.5-flash-lite',
        name: 'Gemini 2.5 Flash-Lite',
        description: 'High-quota, cost-effective model for solution generation'
      }
    ]
  },
  {
    ...
    geminiModels: [
      ...
      },
      {
        id: 'gemini-2.5-flash',
        name: 'Gemini 2.5 Flash',
        description: 'Balanced debugging assistance with good reasoning'
      },
      {
        id: 'gemini-2.5-flash-lite',
        name: 'Gemini 2.5 Flash-Lite',
        description: 'High-quota model perfect for debugging iterations'
      }
    ]
  }
]
  ...
  const handleProviderChange = (provider: APIProvider) => {
    ...
    if (currentConfig?.apiProvider === provider) {
      if (provider === 'openai') {
        ...
        setExtractionModel(currentConfig?.extractionModel || 'gemini-2.5-flash')
        setSolutionModel(currentConfig?.solutionModel || 'gemini-2.5-flash')
        setDebuggingModel(currentConfig?.debuggingModel || 'gemini-2.5-flash')
      }
    } else {
      if (provider === 'openai') {
      ...
      >
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2 mt-4">
            ...
            <div className="bg-black/30 border border-white/10 rounded-lg p-3">
              <div className="grid grid-cols-2 gap-y-2 text-xs">
                ...
                <div className="text-white/70">Toggle Mouse Click</div>
                ...
                <div className="text-white/70">Reset Window Position</div>
                <div className="text-white/90 font-mono">Ctrl+' / Cmd+'</div>
          ...
          <div className="space-y-4 mt-4">
            <label className="text-sm font-semibold text-white">AI Model Selection</label>
